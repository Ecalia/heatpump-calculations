import sys
sys.path.append('../')
from Air_Conditioner import AirConditionerStudy
from CoolProp.CoolProp import PropsSI as PSI

class AirConditionerStudy(AirConditionerStudy):
    ...
    def set_boundary_conditions(self, T_cond=80, T_evap=20, T_overheating=5, T_subcooling=5):
        ...
        pr_cond = (p_cond-1700/1e5)/p_cond
        pr_evap = (p_evap-4800/1e5)/p_evap
        
        self.comp["evaporator"].set_attr(pr=pr_evap, Q=self.Q_in)
        ...
        self.comp["condenser"].set_attr(pr=pr_cond)
